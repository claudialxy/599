...
export default class ShoppingCartNew extends Component {
  ...
  checkItem(sectionIndex: any, index: any) {
  ...
  minus(sectionIndex: any, index: any) {
    let tempStatus = this.state.status
  ...
  add(sectionIndex: any, index: any) {
    let tempStatus = this.state.status
    let shop = tempStatus[sectionIndex]
    let items = shop.items
    let item = items[index]
  ...
  render() {
    let tempArr = shoppingCartData.data.map((item: any, index: any) => {
      let tempData = {}
