...
public class PrivacyFragment extends DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        int linkColor = requireContext().getResources().getColor(R.color.status_bar_color);
        String contract = "《用户服务协议》";
        SpannableString contractString = new SpannableString(contract);
        contractString.setSpan(clickableSpan, 0, contract.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
